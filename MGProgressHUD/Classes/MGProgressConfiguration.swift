...
@objc public extension MGProgressHUD {
    ...
    @discardableResult
    @objc class func  showLoadingView(_ toView: UIView!, message: String? = nil) -> MGProgressHUD? {
    ...
    @discardableResult
    @objc class func showLoadingFillView(_ toView: UIView!, message: String? = nil) -> MGProgressHUD? {
